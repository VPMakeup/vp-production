      ...
      <div className={styles.about}>
        <SplitSection
          ...
          body={
            <div className={styles.body}>
              ...
              <p>
                When not on set, Victoria can usually be found throwing shapes
                on the potter’s wheel, exploring galleries, travelling to
                far-flung places, cooking, or listening to live music.
              </p>
            </div>
          }
          imageSrc="/VictoriaPolandProfile.jpeg"
        ...
        <ClientLogosSection
          ...
          body={
            <>
              <p>
                As a makeup designer and SFX artist, Victoria has built a
                diverse skill set spanning beauty, character, and prosthetic
                work. She has collaborated with award-winning photographers and
                created makeup for global brands such as Virgin Atlantic,
                easyJet, British Airways, Amazon, Puma, Nike, and New Balance.
              </p>
